...
const TagCard = ({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  return (
    <div
      ...
      className={`w-72 sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${isActive ? 'bg-emerald-500 border-emerald-400 shadow-[0_20px_50px_rgba(16,185,129,0.4)]' : 'bg-white border border-gray-200 shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)]'
        }`}
    >
      {/* The hole punch */}
      ...
      <div className={`w-full h-full rounded-[1.5rem] mt-8 p-8 flex flex-col min-h-[220px] transition-colors duration-700 ${isActive ? 'bg-emerald-700/50' : 'bg-[#f4f4f4]'
        ...
        <p className={`text-sm leading-relaxed font-medium transition-colors duration-700 ${isActive ? 'text-emerald-100' : 'text-gray-500'
          }`}>
          {text}
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Recognitions and certifications I have earned during my academic and professional journey.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Secured academic excellence award during academic session, reflecting strong academic performance."
          ...
          <TagCard
            number="Sept '25"
            title="AI-Trip Planner, Hackathon"
            text="Runner-up in Software App Exhibition by developing an AI-powered trip planner app that helps users customise travel plans efficiently."
          ...
          <TagCard
            number="Aug '25"
            title="Tech-Debate Winner"
            text="Winner for topics including 'Is work from home culture beneficial for the tech industry' and 'Social media - a boon or a bane'." className="md:absolute md:top-[700px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3"
            aosType="fade-left"
            aosDelay="300"
            pathLength={pathLength}
            containerRef={containerRef}
          ...
          <TagCard
            number="May '24"
            title="Innova-thon Competition"
            text="First runner-up in Innova-thon Competition by developing an innovative solution prototype (Kheti App) addressing real-world agricultural challenges."

...
import BULogo from '../assets/about/BU.png';
import ArmyLogo from '../assets/about/army.jpg';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Institution heading with logo */}
        <div className="flex items-start gap-4 mb-3">
          {/* Logo container */}
          <div
            className={`w-14 h-14 min-w-[56px] rounded-xl overflow-hidden flex items-center justify-center bg-white border transition-all duration-700 ${
              isActive
                ? 'border-white/30 shadow-[0_8px_20px_rgba(0,0,0,0.15)]'
          ...
          {/* Institution name */}
          <h3
            className={`text-2xl font-black tracking-tight transition-colors duration-700 leading-tight ${
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="Jul '23 - Jul '27"
            title="Bundelkhand University, Jhansi"
            text="B.Tech in Computer Science and Engineering (CSE). Current CGPA: 8.9."
            logo={BULogo}
          ...
          {/* Army Public School */}
          <TagCard
            number="Jul '20 - Jul '22"
            title="Army Public School Devlali, Nashik"
            text="Completed CBSE 12th standard with 93% and 10th standard with 95%."
            logo={ArmyLogo}
